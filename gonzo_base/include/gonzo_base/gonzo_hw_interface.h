#ifndef GONZO_HW_INTERFACE_H
#define GONZO_HW_INTERFACE_H


// ROS
#include <ros/ros.h>
#include <urdf/model.h>
#include <gonzo_msgs/EncodersStamped.h>
#include <gonzo_msgs/WheelCmdStamped.h>
...
namespace gonzo_base
{
    ...
    class GonzoHWInterface : public hardware_interface::RobotHW
    {
    public:
        /**
         * \brief Constructor
         ...
         */
        GonzoHWInterface(ros::NodeHandle &nh, urdf::Model *urdf_model = NULL);

        /** \brief Destructor */
        virtual ~GonzoHWInterface() {}
    ...
    protected:
        ...
        void encoderTicksCallback(const gonzo_msgs::EncodersStamped::ConstPtr& msg_encoders);
